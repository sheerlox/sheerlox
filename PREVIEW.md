...
- [alzo-archi/xhpoffice](https://github.com/alzo-archi/xhpoffice) - Write Elixir, generate and run PHP code to leverage rich Microsoft Office libraries in PHP (1 day ago)
...
- [ash-project/igniter](https://github.com/ash-project/igniter) - A code generation and project patching framework. (5 days ago)
- [podium/elixir-secure-coding](https://github.com/podium/elixir-secure-coding) - An interactive cybersecurity curriculum designed for enterprise use at software companies using Elixir (6 days ago)
- [superfly/flyio-price-calc-ex](https://github.com/superfly/flyio-price-calc-ex) - Prototype pricing calculator/estimator  (6 days ago)
