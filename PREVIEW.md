...
- [insurgent-lab/is-in-pr-action](https://github.com/insurgent-lab/is-in-pr-action) - Github Action for checking if the current commit is part of a PR (2 weeks ago)
- [open-teach-lab/exercice_rebase_interactif](https://github.com/open-teach-lab/exercice_rebase_interactif) -  (3 weeks ago)
...
- [lpil/mix-test.watch](https://github.com/lpil/mix-test.watch) - 🎠   Because TDD is awesome (1 week ago)
- [googlecreativelab/digital-wellbeing-experiments-toolkit](https://github.com/googlecreativelab/digital-wellbeing-experiments-toolkit) - Code components for starting your own Digital Wellbeing experiments (2 weeks ago)
...
- [logdyhq/logdy-core](https://github.com/logdyhq/logdy-core) - Stream command and output content to web UI with autogenerated filters. Transform content with TypeScript. (2 weeks ago)
- [bamorim/typed_ecto_schema](https://github.com/bamorim/typed_ecto_schema) - A library to define Ecto schemas with typespecs without all the boilerplate code. (2 weeks ago)
- [phoenixframework/dns_cluster](https://github.com/phoenixframework/dns_cluster) - Simple DNS clustering for distributed Elixir nodes (2 weeks ago)
