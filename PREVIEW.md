...
- [sheerlox/StackOverflow-Answers-Code](https://github.com/sheerlox/StackOverflow-Answers-Code) -  (4 days ago)
- [sheerlox/vscode-settings](https://github.com/sheerlox/vscode-settings) -  (4 days ago)
- [badges/shields](https://github.com/badges/shields) - Concise, consistent, and legible badges in SVG and raster format (5 days ago)
...
- [phoenixframework/flame](https://github.com/phoenixframework/flame) (2 days ago)
- [ash-project/spark](https://github.com/ash-project/spark) - Tooling for building DSLs in Elixir (2 days ago)
- [ash-project/ash_cloak](https://github.com/ash-project/ash_cloak) - An extension for encrypting and decrypting attributes of Ash resources. (2 days ago)
- [badges/shields](https://github.com/badges/shields) - Concise, consistent, and legible badges in SVG and raster format (5 days ago)
- [jordwest/news-feed-eradicator](https://github.com/jordwest/news-feed-eradicator) - A browser extension that deletes your news feed and replaces it with a nice quote (5 days ago)
- [morph-labs/rift](https://github.com/morph-labs/rift) - Rift: an AI-native language server for your personal AI software engineer (6 days ago)
