...
- [magic-inspector/auto-inspector](https://github.com/magic-inspector/auto-inspector) - Web Testing AI Agent - Write your specs, it does the rest (1 day ago)
- [unifiedjs/collective](https://github.com/unifiedjs/collective) - How the unified collective is governed (2 days ago)
...
- [besughi/elixir-k6](https://github.com/besughi/elixir-k6) - Quick and painless load testing for Elixir applications. (2 days ago)
- [grafana/k6](https://github.com/grafana/k6) - A modern load testing tool, using Go and JavaScript - https://k6.io (2 days ago)
- [Dolibarr/dolibarr](https://github.com/Dolibarr/dolibarr) - Dolibarr ERP CRM is a modern software package to manage your company or foundation's activity (contacts, suppliers, invoices, orders, stocks, agenda, accounting, ...). it's an open source Web application (written in PHP) designed for businesses of any sizes, foundations and freelancers. (3 days ago)
- [elixir-wallaby/wallaby](https://github.com/elixir-wallaby/wallaby) - Concurrent browser tests for your Elixir web apps. (4 days ago)
- [beam-community/ex_machina](https://github.com/beam-community/ex_machina) - Create test data for Elixir applications (4 days ago)
- [elixirkoans/elixir-koans](https://github.com/elixirkoans/elixir-koans) - Elixir learning exercises (4 days ago)
- [quantum-elixir/quantum-core](https://github.com/quantum-elixir/quantum-core) - :watch: Cron-like job scheduler for Elixir (4 days ago)
