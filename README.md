...
- [open-teach-lab/exercice_rebase_interactif](https://github.com/open-teach-lab/exercice_rebase_interactif) -  (4 weeks ago)
...
- [lpil/mix-test.watch](https://github.com/lpil/mix-test.watch) - 🎠   Because TDD is awesome (2 weeks ago)
...
- [logdyhq/logdy-core](https://github.com/logdyhq/logdy-core) - Stream command and output content to web UI with autogenerated filters. Transform content with TypeScript. (3 weeks ago)
- [bamorim/typed_ecto_schema](https://github.com/bamorim/typed_ecto_schema) - A library to define Ecto schemas with typespecs without all the boilerplate code. (3 weeks ago)
